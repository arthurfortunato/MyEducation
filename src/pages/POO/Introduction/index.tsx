    ...
    <Container>
      ...
      <Section className="section section__abstract-types">
        ...
        <p>
          ...
          presentes na linguagem de programação que escolhemos. O que a
          programação orientada a objetos nos permite fazer é criar novos tipos
          na linguagem. Chamamos esses tipos de TAD (Tipos Abstratos de Dados).
          <br />
          <br />
          ...
          representar algo mais complexo, cada tipo usado para armazenar valores
          é chamado de atributo. E também podem conter comportamentos, chamados
          métodos, que nada mais são do que funções que permitem a alteração e
          leitura dos dados ou interagir com o ambiente externo ao TAD.
          <br />
          <br />
          ...
          conterá nome, email e telefone.Agenda se comportará como uma lista de
          Contatos, contendo métodos que permitam adicionar e remover Contatos,
          assim como buscar pelo nome. Assim, centralizamos toda informação do
          contato em uma única entidade o que acaba com as chances de misturar
          os dados. E a entidade Agenda tem a responsabilidade de manipular os
          contatos centralizando as operações que o sistema pode fazer.
          <br />
          <br />
      ...
      <Section className="section section__object">
        ...
        <p>
          ...
          <br />
          <br />
          Essa notação é extremamente simples e concisa. Um objeto é detonado
          pela abertura de chaves, os atributos são pares chave-valor separados
          por dois pontos (:) e os métodos são funções.
          <br />
          <br />
          Por exemplo:
          <br />
        ...
        <p>
          Observe que para nos referirmos a um atributo ou método do objeto de
          dentro dele mesmo precisamos usar o prefixo this para saber que é algo
          que pertence ao objeto e não alguma variável declarada previamente.
          <br />
