export const paragraphs = [
  `A Orientação a Objetos é uma abordagem para a programação que se baseia em 
  conceitos como classes, objetos, herança, polimorfismo e encapsulamento. 
  Esses conceitos são utilizados para modelar o mundo real em uma forma 
  computacional, tornando a programação mais clara, organizada e reutilizável.`,

  `A orientação a objetos é um paradigma de programação que se
  ...
  `Classe: é uma estrutura que descreve um conjunto de
  ...
  `Objeto: é uma instância de uma classe, ou seja, é uma
  ...
  `Polimorfismo: é a capacidade de um objeto ser tratado
  ...
  `Encapsulamento: é o mecanismo que garante que os
