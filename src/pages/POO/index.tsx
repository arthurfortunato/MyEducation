      ...
      <BodyContainerStyled>
        <div>
          ...
          <Link to="/poo/class" className="link">
            <Card width="300px" height="100px" backgroundImage={classe}>
              <p>2. CLASSE E OBJETO</p>
            </Card>
          </Link>
          <Link to="/poo/polymorphism" className="link">
            <Card width="300px" height="100px" backgroundImage={polimorfismo}>
              <p>3. POLIMORFISMO</p>
            </Card>
          </Link>
          <Link to="/poo/inheritance" className="link">
            <Card width="300px" height="100px" backgroundImage={heranca}>
              <p>4. HERANÇA</p>
            </Card>
          </Link>
          <Link to="/poo/encapsulation" className="link">
            <Card width="300px" height="100px" backgroundImage={encapsulamento}>
