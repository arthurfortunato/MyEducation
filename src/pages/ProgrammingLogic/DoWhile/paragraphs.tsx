...
export const paragraphs = [
  <p>
    ...
    que é semelhante ao while. A diferença é que o do-while executa o bloco de
    código pelo menos uma vez antes de verificar a condição de loop. Depois que
    o bloco de código é executado, a condição de loop é verificada e o loop é
    repetido até que a condição seja avaliada como falsa.
  </p>,
  <>
  ...
  <>
    <p>
      Por exemplo, podemos usar o do-while para solicitar que o usuário insira
  ...
  <p>
    É importante lembrar que o do-while é adequado para situações em que é
    necessário executar o bloco de código pelo menos uma vez. Caso contrário, o
    while é uma melhor opção. Além disso, assim como o while, é importante ter
    cuidado ao usar o do-while para evitar loops infinitos ou loops que nunca
    sejam executados.
  </p>,
];
