  ...
  return (
    <Container>
      ...
      <Section className="section section__functions">
        <p>
          Podemos ter duas interpretações do que são funções. A primeira de que
          uma função é um trecho de código em que damos um nome e que é
          executado a cada vez que é chamado. Exemplo:
        </p>
        ...
        <p>
          ...
          vez que é chamada a função, o seu código é executado. Para tornar a
          função mais reutilizável, podemos parametriza-la. Para isso,
        ...
        <p>
          Entre os parêntesis adicionamos a declaração de duas variáveis, comeco
      ...
      <Section className="section section__ways-declare">
        ...
        <p>
          A primeira função foi declarada como a forma tradicional apresentada
          antes. No segundo caso foi usado uma função anônima, isto é, sem nome.
          Note que seguido de function não há declaração de um nome para a
          função. O que define o seu nome é a variável. No terceiro caso é
          também uma função anônima porém é usada a chamada função de flecha.
          Onde é declarado os parâmetros de entrada em parêntesis e a sua
