      ...
      <BodyContainerStyled>
        <div>
          ...
          <Link to="/java/spring" className="link">
            <Card width="300px" height="100px" backgroundImage={framework}>
              <p>2. SPRING FRAMEWORK</p>
            </Card>
          </Link>
          <Link to="/java/jvm" className="link">
            <Card width="300px" height="100px" backgroundImage={jvm}>
              <p>3. JVM</p>
            </Card>
          </Link>
          <Link to="/java/jdk" className="link">
            <Card width="300px" height="100px" backgroundImage={jdk}>
              <p>4. JDK</p>
            </Card>
          </Link>
          <Link to="/java/jdbc" className="link">
            <Card width="300px" height="100px" backgroundImage={jdbc}>
              <p>4. JDBC</p>
            </Card>
          </Link>
          <Link to="/java/maven" className="link">
            <Card width="300px" height="100px" backgroundImage={maven}>
              <p>4. MAVEN</p>
            </Card>
          </Link>
          <Link to="/java/springboot" className="link">
            <Card width="300px" height="100px" backgroundImage={springBoot}>
              <p>4. SPRING BOOT</p>
            </Card>
          </Link>
        </div>
