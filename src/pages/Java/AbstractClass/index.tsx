  ...
  return (
    <Container>
      ...
      <Section className="section section__abstract_class">
        <p>
          Em Java, uma classe abstrata é uma classe que não pode ser instanciada
          diretamente e que geralmente é usada como uma classe base para outras
          classes derivadas. Uma classe abstrata pode ter métodos abstratos, que
          são métodos sem implementação, e métodos concretos, que têm
      ...
      <Section className="section section__abstract_class">
        ...
        <p>
          ...
          <br />
          <br />
          Implementação de métodos: Uma classe abstrata pode ter métodos
          abstratos e métodos concretos com implementação definida, enquanto uma
          interface só pode ter métodos abstratos, ou seja, sem implementação.
          <br />
          <br />
          Herança: Uma classe abstrata pode estender outra classe abstrata ou
          implementar uma ou mais interfaces, enquanto uma interface só pode
          estender outras interfaces.
          <br />
          <br />
          Modificadores de acesso: Os membros de uma interface são públicos e
          abstratos por padrão, enquanto uma classe abstrata pode ter membros
          com qualquer tipo de modificador de acesso (public, protected,
          private).
          <br />
          <br />
          Construtores: Uma classe abstrata pode ter construtores, enquanto uma
          interface não pode.
          <br />
          <br />
